...
public class MainActivity extends Activity {
	...
	public static String lingminzhi;
	public static String getVADTHRESHOLD(){
		return lingminzhi;
	}
	// 日志输出窗体
...
//			rg.getChildAt(3).setEnabled(false);
//		}
		...
		onChecked = new RadioGroup.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				if (checkedId == R.id.radioRealtimeYes) {
					realtimeValue = "yes";
					lingminzhi = "1";
				} else if (checkedId == R.id.radioRealtimeYes2) {
					realtimeValue = "yes";
					lingminzhi = "5";

				} else if (checkedId == R.id.radioRealtimeYes3) {
					realtimeValue = "yes";
					lingminzhi = "10";
